...
public class NewHtmlGeneratorService implements HtmlGenerateServiceInterface {
	...
	@Override
	public Writer createHtmlTags(Writer writer, ModelMain modelMain) throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException {
...
//		log.info("within container --> dm lg "+modelMain.getPageName());
		...
		Class<?> clazz = Class.forName("com.paxcel.mail.components.Container");
